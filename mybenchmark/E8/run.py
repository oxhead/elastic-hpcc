...
def main():
    ...
    default_setting.set_config('cluster.target', "/home/ubuntu/elastic-hpcc/template/elastic_1thor_4roxie_locality.xml")
    default_setting.set_config('cluster.benchmark', "/home/ubuntu/elastic-hpcc/conf/10driver.yaml")
    default_setting.set_config('experiment.id', 'E8')
    ...
    output_dir = os.path.join(
        ...
        default_setting['experiment.id'], "nolocality_4N_1R_{}q_{}sec".format(
