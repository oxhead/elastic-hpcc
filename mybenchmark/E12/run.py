...
def main():
    ...
    default_setting.set_config('cluster.target', "/home/chsu6/elastic-hpcc/template/elastic_8thor_8roxie_locality.xml")
    default_setting.set_config('cluster.benchmark', "/home/chsu6/elastic-hpcc/conf/4driver.yaml")
    default_setting.set_config('experiment.id', 'E12')
    ...
    output_dir = os.path.join(
        ...
        default_setting['experiment.id'], "locality_64+32threads_full8_8N_8R_{}q_{}sec".format(
