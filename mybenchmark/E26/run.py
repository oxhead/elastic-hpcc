...
def main(dp_type, dp_model, selective_run, check_success, num_iters=1):
    ...
    default_setting.set_config('experiment.id', 'E26')
    ...
    for experiment in generate_experiments(default_setting, final_variable_setting_list, experiment_dir=script_dir, timeline_reuse=True, wait_time=1, check_success=check_success, restart_hpcc=True):
