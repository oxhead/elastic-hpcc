...
def main(dp_type, dp_model, selective_run, check_success, num_iters=1):
    ...
    default_setting.set_config('cluster.target', "/home/chsu6/elastic-hpcc/template/elastic_1thor_16roxie_locality_nfs.xml")
    default_setting.set_config('cluster.benchmark', "/home/chsu6/elastic-hpcc/conf/benchmark_template.yaml")
    default_setting.set_config('experiment.id', 'E28')
    default_setting.set_config('experiment.goal', '''
    1. Once mode to prove throughput for 16 nodes
    ''')
    ...
    default_setting.set_config('experiment.workload_endpoints', 16)
    # total driver clients = benchmark_processors * benchmark_clients
    default_setting.set_config('experiment.benchmark_processors', 4)
    ...
    for experiment in generate_experiments(default_setting, final_variable_setting_list, experiment_dir=script_dir, timeline_reuse=True, wait_time=1, check_success=check_success, restart_hpcc=False, timeout=300):
...
if __name__ == "__main__":
    ...
    for dp_type, dp_model in dp_set:
        ...
        main(dp_type, dp_model, True, True, num_iters=1)
