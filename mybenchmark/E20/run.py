...
from mybenchmark.E20 import myplacement
...
def main(run_id, dp_type, selective_run, check_success):
    ...
    default_setting.set_config('experiment.id', 'E20')
    ...
    elif data_placement_type == 'fine_all':
        data_placement_list = fine_all_data_placement_list
...
if __name__ == "__main__":
    for run_id in range(1, 7):
        for dp_type in ['coarse', 'fine_all']:
        #for dp_type in ['coarse']:
        #for dp_type in ['fine_all']:
            main(run_id, dp_type, True, True)
