...
def main(run_id, dp_type, dp_model, selective_run, check_success):
    ...
    for experiment in generate_experiments(default_setting, variable_setting_list, experiment_dir=script_dir, timeline_reuse=True, wait_time=1, check_success=check_success, restart_hpcc=False):
