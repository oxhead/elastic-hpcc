...
def main(run_id, dp_type, dp_model, selective_run, check_success):
    ...
    default_setting.set_config('experiment.id', 'E24')
    default_setting.set_config('experiment.goal', '''
    1. Test distributino over apps
    2. One partition per app.
    ''')
    ...
    for experiment in generate_experiments(default_setting, variable_setting_list, experiment_dir=script_dir, timeline_reuse=True, wait_time=1, check_success=check_success, restart_hpcc=True):
...
if __name__ == "__main__":
    for run_id in range(41, 42):
        ...
        for dp_type, dp_model in dp_set:
            ...
            main(run_id, dp_type, dp_model, True, True)
