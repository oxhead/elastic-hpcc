...
def generate_output(input_list, file_path):
	with open(file_path, 'w') as f:
		input_set = set(input_list)
		print(file_path, len(input_set))
		for i in input_set:
			f.write("{}\n".format(i.strip()))


generate_output(firstname_list, 'firstname_list.txt')
generate_output(lastname_list, 'lastname_list.txt')
generate_output(zip_list, 'zip_list.txt')
generate_output(city_list, 'city_list.txt')
generate_output(state_list, 'state_list.txt')
