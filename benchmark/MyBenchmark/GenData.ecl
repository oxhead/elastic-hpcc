...
I5 := INDEX(D1,{PersonID,LastName,FirstName,RecPos},'~PROGGUIDE::EXAMPLEDATA::KEYS::People.PersonID,LastName.FirstName');
I6 := INDEX(D1,{PersonID},{FirstName,LastName,MiddleInitial,Gender,Street,City,State,Zip,RecPos},'~PROGGUIDE::EXAMPLEDATA::KEYS::People.PersonID.Payload');
I7 := INDEX(D2,{PersonID},{Account,OpenDate,IndustryCode,AcctType,AcctRate,Code1,Code2,HighCredit,Balance,RecPos},'~PROGGUIDE::EXAMPLEDATA::KEYS::Accounts.PersonID.Payload');
I8 := INDEX(D1,{LastName,FirstName},{D1},'~PROGGUIDE::EXAMPLEDATA::KEYS::People.LastName.FirstName.Payload');
I9 := INDEX(D1,{State,City,Zip,Lastname,Firstname},{D1},'~PROGGUIDE::EXAMPLEDATA::KEYS::People.State.City.Zip.LastName.FirstName.Payload');
I10 := INDEX(D1,{PersonID,State,City,Zip,Gender,Lastname,Firstname},{D1},'~PROGGUIDE::EXAMPLEDATA::KEYS::People.All.Payload');
...
B9 := BUILDINDEX(I9,OVERWRITE);
B10 := BUILDINDEX(I10,OVERWRITE);

P2 := PARALLEL(B1,B2,B3,B4,B5,B6,B7,B8,B9,B10);
