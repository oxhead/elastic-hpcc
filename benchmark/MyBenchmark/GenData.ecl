...
base_kids_sort := SORT(base_kids,PersonID);
...
Layout_Combined AddKids(Layout_Combined L, base_kids R) := TRANSFORM
  ...
  SELF := L;
  END;
base_combined := DENORMALIZE( base_people_dist_by_personid , 
															base_kids_dist, 
...
//write files to disk
O1_1 := OUTPUT(PROJECT(base_people_dist_by_personid,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_PersonID',OVERWRITE);
O1_2 := OUTPUT(PROJECT(base_people_dist_by_firstname,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_FirstName',OVERWRITE);
O1_3 := OUTPUT(PROJECT(base_people_dist_by_lastname,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_LastName',OVERWRITE);
O1_4 := OUTPUT(PROJECT(base_people_dist_by_state,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_State',OVERWRITE);
O1_5 := OUTPUT(PROJECT(base_people_dist_by_city,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_City',OVERWRITE);
O1_6 := OUTPUT(PROJECT(base_people_dist_by_zip,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Dist::Data_People_Zip',OVERWRITE);
P1 := SEQUENTIAL(O1_1,O1_2,O1_3,O1_4,O1_5,O1_6);

O2_1 := OUTPUT(PROJECT(base_people_sort_by_personid,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_PersonID',OVERWRITE);
O2_2 := OUTPUT(PROJECT(base_people_sort_by_firstname,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_FirstName',OVERWRITE);
O2_3 := OUTPUT(PROJECT(base_people_sort_by_lastname,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_LastName',OVERWRITE);
O2_4 := OUTPUT(PROJECT(base_people_sort_by_state,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_State',OVERWRITE);
O2_5 := OUTPUT(PROJECT(base_people_sort_by_city,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_City',OVERWRITE);
O2_6 := OUTPUT(PROJECT(base_people_sort_by_zip,Layout_Person),,$.DeclareData.OUTPUT_DIR+'Sort::Data_People_Zip',OVERWRITE);
P2 := SEQUENTIAL(O2_1,O2_2,O2_3,O2_4,O2_5,O2_6);

O3_1 := OUTPUT(base_kids_dist,,$.DeclareData.OUTPUT_DIR+'Dist::Data_Accounts_PersonID',OVERWRITE);
O3_2 := OUTPUT(base_kids_sort,,$.DeclareData.OUTPUT_DIR+'Sort::Data_Accounts_PersonID',OVERWRITE);
P3 := SEQUENTIAL(O3_1,O3_2);

D1_1 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_PersonID',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D1_2 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_FirstName',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D1_3 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_LastName',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D1_4 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_State',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D1_5 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_City',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D1_6 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_People_Zip',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);

D2_1 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_PersonID',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D2_2 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_FirstName',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D2_3 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_LastName',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D2_4 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_State',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D2_5 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_City',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D2_6 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_People_Zip',{Layout_Person,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);


D3_1 := DATASET($.DeclareData.OUTPUT_DIR+'Dist::Data_Accounts_PersonID',{Layout_Accounts_Link,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);
D3_2 := DATASET($.DeclareData.OUTPUT_DIR+'Sort::Data_Accounts_PersonID',{Layout_Accounts_Link,UNSIGNED8 RecPos{VIRTUAL(fileposition)}}, THOR);


I1_1 := INDEX(D1_1,{PersonID,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_PersonID');
I1_2 := INDEX(D1_2,{FirstName,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_FirstName');
I1_3 := INDEX(D1_3,{LastName,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_LastName');
I1_4 := INDEX(D1_4,{State,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_State');
I1_5 := INDEX(D1_5,{City,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_City');
I1_6 := INDEX(D1_6,{Zip,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_People_Zip');

I2_1 := INDEX(D2_1,{PersonID,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_PersonID');
I2_2 := INDEX(D2_2,{FirstName,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_FirstName');
I2_3 := INDEX(D2_3,{LastName,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_LastName');
I2_4 := INDEX(D2_4,{State,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_State');
I2_5 := INDEX(D2_5,{City,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_City');
I2_6 := INDEX(D2_6,{Zip,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_People_Zip');
...
P4 := PARALLEL(B1_1,B1_2,B1_3,B1_4,B1_5,B1_6);
P5 := PARALLEL(B2_1,B2_2,B2_3,B2_4,B2_5,B2_6);


I3_1 := INDEX(D3_1,{PersonID,RecPos},$.DeclareData.OUTPUT_DIR+'Dist::Idx_Accounts_PersonID');
I3_2 := INDEX(D3_2,{PersonID,RecPos},$.DeclareData.OUTPUT_DIR+'Sort::Idx_Accounts_PersonID');
B3_1 := BUILDINDEX(I3_1,OVERWRITE);
B3_2 := BUILDINDEX(I3_2,OVERWRITE);
P6 := SEQUENTIAL(B3_1,B3_2);
SEQUENTIAL(P1,P2,P3,P4,P5,P6);
