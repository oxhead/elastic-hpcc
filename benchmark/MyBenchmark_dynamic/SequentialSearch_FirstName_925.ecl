...
ds := DATASET('~MyBenchmark::Data_Sorted_People_FirstName_925', {Layout_Person,UNSIGNED8 RecPos{virtual(fileposition)}}, THOR);
idx := INDEX(ds, {FirstName,RecPos}, '~MyBenchmark::Idx_Sorted_People_FirstName_925');
