...
layout_elastic_4N_1R = {
    ...
    'node2':
        [
            'data_sorted_people_firstname._1*',
            'data_sorted_people_lastname._1*',
            'data_sorted_people_city._1*',
            'data_sorted_people_zip._1*',
            'data_unsorted_people_firstname._1*',
            'data_unsorted_people_lastname._1*',
            'data_unsorted_people_city._1*',
            'data_unsorted_people_zip._1*',
        ],
    'node3':
        [
            'data_sorted_people_firstname._2*',
            'data_sorted_people_lastname._2*',
            'data_sorted_people_city._2*',
            'data_sorted_people_zip._2*',
            'data_unsorted_people_firstname._2*',
            'data_unsorted_people_lastname._2*',
            'data_unsorted_people_city._2*',
            'data_unsorted_people_zip._2*',
        ],
    'node4':
        [
            'data_sorted_people_firstname._3*',
            'data_sorted_people_lastname._3*',
            'data_sorted_people_city._3*',
            'data_sorted_people_zip._3*',
            'data_unsorted_people_firstname._3*',
            'data_unsorted_people_lastname._3*',
            'data_unsorted_people_city._3*',
            'data_unsorted_people_zip._3*',
        ],
    'node5':
        [
            'data_sorted_people_firstname._4*',
            'data_sorted_people_lastname._4*',
            'data_sorted_people_city._4*',
            'data_sorted_people_zip._4*',
            'data_unsorted_people_firstname._4*',
            'data_unsorted_people_lastname._4*',
            'data_unsorted_people_city._4*',
            'data_unsorted_people_zip._4*',
        ],
    'node6': [],
    'node7': [],
    'node8': [],
...
layout_elastic_4N_xR_optimized = {
    'node1': [],
    'node2':
        [
            'data_sorted_people_firstname._1*',
...
if __name__ == "__main__":
    ...
    #do_main(node_id, dataset_dir, layout_none)
    #do_main(node_id, dataset_dir, layout_complete)
    do_main(node_id, dataset_dir, layout_elastic_4N_xR_optimized)
    #do_main(node_id, dataset_dir, layout_elastic_4N_1R)
    #do_main(node_id, dataset_dir, layout_elastic_4N_2R)
